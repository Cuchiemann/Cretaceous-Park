...
object Tutorial {
    val steps: List<TutorialStep> = listOf(
        ...
        TutorialStep("Construye un recinto",
            "Abre Recintos, elige Valla ligera y arrastra un rectángulo sobre la hierba de al menos 6×6 tiles. Deja hueco: las vallas no pueden tocar caminos.",
        ...
        TutorialStep("Un camino hasta el recinto",
            "Abre Caminos y arrastra desde el camino de la entrada hasta llegar junto a la valla. Los visitantes solo se mueven por caminos.",
        ...
        TutorialStep("Energía",
            "Abre Centros y construye un Generador junto a un camino. Da energía en 10 tiles a laboratorios, tiendas y vallas eléctricas.",
        ...
        TutorialStep("Envía una expedición",
            "Abre 🌍 Expediciones y envía un equipo al Cañón Rojo. Tarda 60 s y vuelve con fósiles de herbívoros pequeños.",
        ...
        TutorialStep("Tu primer dinosaurio",
            "Abre 🧬 ADN. Cuando una especie llegue al 50 % de ADN, elige tu recinto e incuba. Si falta ADN, envía más expediciones.",
        ...
        TutorialStep("Servicios para visitantes",
            "Abre Servicios y coloca una Tienda de comida junto al camino y con energía. Los visitantes cómodos gastan más.",
            0, Category.SERVICES) { w -> w.hasBuilding("shop_food") || w.hasBuilding("shop_drink") },
        TutorialStep("Investigación",
            "Construye un Centro de Investigación y en 🔬 empieza un nodo: la valla media y los comederos automáticos son una buena primera compra.",
