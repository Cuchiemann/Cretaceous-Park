...
object Tutorial {
    val steps: List<TutorialStep> = listOf(
        ...
        TutorialStep("Construye un recinto",
            "Abre Construir → Recintos, elige Valla ligera y dibuja con el dedo el contorno de un recinto de al menos 6×6 tiles sobre la hierba; luego pulsa Confirmar. Las vallas no pueden tocar caminos.",
            0, Category.ENCLOSURE) { w -> w.enclosures().any { it.tiles >= 36 } },
        TutorialStep("Comida para herbívoros",
            "Coloca un Comedero de herbívoros dentro del recinto: toca el mapa para poner el plano, arrástralo si hace falta y pulsa Confirmar.",
        ...
        TutorialStep("Un camino hasta el recinto",
            "Abre Construir → Caminos, dibuja desde el camino de la entrada hasta llegar junto a la valla y pulsa Confirmar. Los visitantes solo se mueven por caminos.",
